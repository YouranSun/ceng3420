...
void handle_slli(unsigned int cur_inst) {
     ...
     */
    unsigned int rd = MASK11_7(cur_inst), rs1 = MASK19_15(cur_inst);
    int imm12 = sext(MASK24_20(cur_inst), 12);
    NEXT_LATCHES.REGS[rd] = (int)((unsigned)CURRENT_LATCHES.REGS[rs1] << imm12);
}
...
void handle_lui(unsigned int cur_inst) {
    ...
    int imm20 = sext(MASK31_20(cur_inst), 20);
...
void handle_sll(unsigned int cur_inst) {
    ...
    rs1 = MASK19_15(cur_inst),
    rs2 = MASK24_20(cur_inst);
    NEXT_LATCHES.REGS[rd] = (int)((unsigned)CURRENT_LATCHES.REGS[rs1] << CURRENT_LATCHES.REGS[rs2]);
}
...
void handle_jal(unsigned int cur_inst) {
     ...
     */
    unsigned int rd = MASK11_7(cur_inst);
    int imm20 = sext(MASK31(cur_inst) << 20 | MASK30_21(cur_inst) << 1 | MASK20(cur_inst) << 11 | MASK19_15(cur_inst) << 15 | MASK14_12(cur_inst) << 12, 20);
    NEXT_LATCHES.REGS[rd] = CURRENT_LATCHES.PC + 4;
    NEXT_LATCHES.PC = CURRENT_LATCHES.PC + imm20;
}
...
void handle_lh(unsigned int cur_inst) {
     ...
     */
    unsigned int rd = MASK11_7(cur_inst), rs1 = MASK19_15(cur_inst);
    int imm12 = MASK31_20(cur_inst), pos = sext(imm12, 12) + CURRENT_LATCHES.REGS[rs1];
    NEXT_LATCHES.REGS[rd] = sext(MASK7_0(MEMORY[pos]) \
                                + (MASK7_0(MEMORY[pos + 1]) << 8), 16);
}
...
void handle_lw(unsigned int cur_inst) {
    ...
    int imm12 = MASK31_20(cur_inst), pos = sext(imm12, 12) + CURRENT_LATCHES.REGS[rs1];
    NEXT_LATCHES.REGS[rd] = sext(MASK7_0(MEMORY[pos]) \
                                + (MASK7_0(MEMORY[pos + 1]) << 8)\
                                + (MASK7_0(MEMORY[pos + 2]) << 16) \
                                + (MASK7_0(MEMORY[pos + 3]) << 24), 32);
}
...
void handle_sh(unsigned int cur_inst) {
    ...
    unsigned int rs1 = MASK19_15(cur_inst), rs2 = MASK24_20(cur_inst);
    int imm12 = (MASK31_25(cur_inst) << 5) + MASK11_7(cur_inst);
    int pos = sext(imm12, 12) + CURRENT_LATCHES.REGS[rs1];
    MEMORY[pos] = MASK7_0(CURRENT_LATCHES.REGS[rs2]);
    MEMORY[pos + 1] = MASK15_8(CURRENT_LATCHES.REGS[rs2]);
}
...
void handle_sw(unsigned int cur_inst) {
    ...
    MEMORY[pos] = MASK7_0(CURRENT_LATCHES.REGS[rs2]);
    MEMORY[pos + 1] = MASK15_8(CURRENT_LATCHES.REGS[rs2]);
    MEMORY[pos + 2] = MASK23_16(CURRENT_LATCHES.REGS[rs2]);
    MEMORY[pos + 3] = MASK31_24(CURRENT_LATCHES.REGS[rs2]);
}
